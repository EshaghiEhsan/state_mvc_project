                                ...
                                <form class="row" action="<?= route('admin.post.update',[$post->id]) ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            ...
                                            <input value="<?= oldOrValue('title',$post->image) ?>" name="image" type="file" id="image" class="form-control-file  <?= errorClass('image') ?>">
                                            <img src="<?= asset($post->image) ?>" width="200px" height="150" class="mt-4">
                                            <?= errorText('image') ?>
                                        </fieldset>
                                    </div>
