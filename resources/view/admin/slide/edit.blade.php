                                ...
                                <form class="row" action="<?= route('admin.slide.update',[$slide->id]) ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            ...
                                            <input value="<?= oldOrValue('image',$slide->image) ?>" name="image" type="file" id="image" class="form-control-file <?= errorClass('image') ?> ">
                                            <img src="<?= asset($slide->image) ?>" width="200px" height="150" class="mt-4">
                                            <?= errorText('image') ?>
                                        </fieldset>
                                    </div>
